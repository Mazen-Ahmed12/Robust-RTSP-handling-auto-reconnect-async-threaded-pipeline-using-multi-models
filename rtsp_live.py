...
os.environ["OPENCV_FFMPEG_CAPTURE_OPTIONS"] = (
    "rtsp_flags;prefer_tcp"  # Alternative TCP flag
)
os.environ["OPENCV_VIDEOIO_PRIORITY_MSMF"] = (
    "0"  # Disable MSMF backend entirely (forces FFmpeg)
)
...
def shutdown_executor():
    print("[APP] Shutting down global ThreadPoolExecutor...")
